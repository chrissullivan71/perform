		...
		const SYLLABLE_DICT = {
			...
			"swarthy": ["swar", "thy"],
			"insult": ["in", "sult"],
			"shillelagh": ["shil", "lay", "lagh"],
			"warning": ["warn", "ing"],
			"rusty": ["rus", "ty"],
			"rapiers": ["ra", "piers"],
			"devils": ["dev", "ils"],
			"temper": ["tem", "per"],
			"flattened": ["flat", "tened"],
			"football": ["foot", "ball"],
			"row-dee-dow-dow": ["row", "dee", "dow", "dow"],
			"tedious": ["te", "di", "ous"],
			...
			"heathy":        ["hea","thy"],
			"grassy":        ["grass","y"],
			"daisyspangled": ["dai","sy","span","gled"],
			"purling":       ["pur","ling"],
			"craggy":        ["crag","gy"],
			"scotias":       ["sco","tias"],
			"gowany":        ["gow","a","ny"],
